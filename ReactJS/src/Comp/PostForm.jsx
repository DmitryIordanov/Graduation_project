...
const PostForm = ({create}) => {
    ...
    return (
        <form>
            ...
            <MyInput value={post.image}  onChange={e => setPost({...post, image: e.target.value})} type="text" placeholder="Ведіть URL картинки..."/>
            <MyButton onClick={async () => await PostServise.getCreatePostById(post["title"],post["body"], post["image"])}>Створити пост</MyButton>
        </form>
    );
};
